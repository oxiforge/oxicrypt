...
fn cond_sub_l_9(r: &mut [u32; 9]) {
    let l9: [u32; 9] = [
        L_LIMBS[0], L_LIMBS[1], L_LIMBS[2], L_LIMBS[3], L_LIMBS[4], L_LIMBS[5], L_LIMBS[6],
        L_LIMBS[7], 0,
    ];
    let mut tmp = *r;
...
mod tests {
    ...
    fn muladd_general() {
        ...
        let b: [u8; 32] = [
            198, 22, 131, 141, 140, 129, 45, 54, 37, 186, 189, 2, 177, 226, 211, 220, 68, 233, 229,
            144, 80, 170, 172, 111, 139, 95, 100, 41, 185, 28, 129, 15,
        ];
        let c: [u8; 32] = [
