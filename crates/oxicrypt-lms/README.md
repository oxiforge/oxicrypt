...
LMS hash-based signatures (SP 800-208) for CNSA 2.0 firmware signing
...
**[API documentation on docs.rs](https://docs.rs/oxicrypt-lms)** — every public item,
with the standard each one implements.

## Installing

```sh
cargo add oxicrypt-lms
```
