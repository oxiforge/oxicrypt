...
SP 800-108r1, SP 800-56Cr2 and HKDF key derivation functions
...
**[API documentation on docs.rs](https://docs.rs/oxicrypt-kdf)** — every public item,
with the standard each one implements.

## Installing

```sh
cargo add oxicrypt-kdf
```
