...
const KAT_Z_SEED: [u8; 32] = [
    0xac, 0xcd, 0x06, 0xa5, 0x3d, 0x9b, 0x0c, 0xff,
    0x59, 0xfa, 0x11, 0x68, 0x42, 0x7b, 0x31, 0x9e,
    0x2b, 0x6a, 0x9f, 0xd7, 0x04, 0xe9, 0x56, 0xd4,
    0x3a, 0x08, 0xc4, 0x7e, 0x01, 0x15, 0x67, 0xbc,
];
...
mod tests {
    ...
    fn implicit_rejection_different_key() {
        ...
        assert_ne!(k, k_bad, "implicit rejection failed: keys match after tamper");
    }
