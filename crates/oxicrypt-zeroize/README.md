...
Volatile zeroization primitive for oxicrypt CSP types.
...
**[API documentation on docs.rs](https://docs.rs/oxicrypt-zeroize)** — every public item,
with the standard each one implements.

## Installing

```sh
cargo add oxicrypt-zeroize
```
