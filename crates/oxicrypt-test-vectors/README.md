...
NIST-derived KAT constants for oxicrypt power-up self-tests (generated)
...
**[API documentation on docs.rs](https://docs.rs/oxicrypt-test-vectors)** — every public item,
with the standard each one implements.

## Installing

```sh
cargo add oxicrypt-test-vectors
```

This crate supports the oxicrypt module rather than being called directly. Start
with [`oxicrypt-module`](https://crates.io/crates/oxicrypt-module).
