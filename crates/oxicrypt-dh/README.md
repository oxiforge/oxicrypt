...
Finite-field Diffie-Hellman key agreement — RFC 3526 Group 15 (3072-bit)
...
**[API documentation on docs.rs](https://docs.rs/oxicrypt-dh)** — every public item,
with the standard each one implements.

## Installing

```sh
cargo add oxicrypt-dh
```
