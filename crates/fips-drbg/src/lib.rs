...
//!   of the DRBG instance. Zeroization of the state on drop is
//!   part of the crate-wide hardening pass.
...
//! [`fips_module::require_operational`]; KAT runners use a hidden
