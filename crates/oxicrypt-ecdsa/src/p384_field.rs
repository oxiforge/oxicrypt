...
mod tests {
    ...
    fn mul_matches_python_reference() {
        ...
        let a = be([
            0x7e, 0xd6, 0x2b, 0xb2, 0xe3, 0x3a, 0xa2, 0x42, 0x63, 0x7b, 0x07, 0xbc, 0x1d, 0x48,
            0xa4, 0xc2, 0xcc, 0xbb, 0x40, 0xd3, 0xe7, 0x78, 0x87, 0xcd, 0x42, 0xa9, 0x73, 0x4c,
            0xba, 0x58, 0xea, 0x0a, 0xde, 0xad, 0xbe, 0xef, 0xca, 0xfe, 0xba, 0xbe, 0xfe, 0xed,
            0xfa, 0xce, 0x13, 0x37, 0xc0, 0xde,
        ]);
        let b = be([
            ...
            0xb9, 0x1c, 0x81, 0x0f, 0x00, 0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77, 0x88, 0x99,
            0xaa, 0xbb, 0xcc, 0xdd, 0xee, 0xff,
        ]);
