...
mod tests {
    ...
    fn from_bytes_reduced_on_all_ones_equals_expected() {
        ...
        let expected_bytes: [u8; 48] = [
            ...
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x38, 0x9c, 0xb2, 0x7e, 0x0b, 0xc8, 0xd2, 0x20,
            0xa7, 0xe5, 0xf2, 0x4d, 0xb7, 0x4f, 0x58, 0x85,
            0x13, 0x13, 0xe6, 0x95, 0x33, 0x3a, 0xd6, 0x8c,
        ];
    ...
    fn invert_one_is_one() {
        assert_eq!(Scalar384::ONE.invert().to_bytes(), Scalar384::ONE.to_bytes());
    }
