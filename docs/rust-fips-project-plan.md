...
- `acvp-harness` — power-up KAT runner executing 95 KATs green across SHA/SHA-3/SHAKE/HMAC/HKDF/KBKDF/AES (ECB/CBC/CTR/GCM/KW/KWP)/AES-CMAC and the module binary integrity check.
...
- [ ] `fips-rsa`: OAEP
- [x] ACVP harness: scaffolding + power-up KAT runner (95 KATs wired)
